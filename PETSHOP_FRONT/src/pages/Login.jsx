...
export default function Login() {
  ...
  async function onSubmit(e) {
    ...
    if (signError) {
      console.log('Login error:', signError)
      // Extraer mensaje del error - puede venir en differentes formatos
      const errorMessage = signError.response?.data?.error?.message || signError.message || String(signError)
